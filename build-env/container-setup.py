...
deb_files_regex = ['libswsscommon*.deb', 'libnl*.deb', 'libsai*.deb', 'syncd-vs*.deb', 'libyang3_*.deb', 'libyang_*.deb', 'libyang-*_1.0*.deb', 'python3-swsscommon*.deb', '*vpp*.deb', 'libdash*.deb']
